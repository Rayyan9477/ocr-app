...
export class PreprocessingService {
     ...
     */
    async preprocessDocument(inputPath, options = {}) {
        const operations = [];
        const errors = [];
        try {
                ...
                try {
                    ...
                    if (highlightResults.hasHighlights) {
                        ...
                        if (options.enhanceHighlights) {
                            const enhancedPath = await this.enhanceHighlightedRegions(finalOutputPath, highlightResults.highlightRegions, sessionDir);
     ...
     */
    async enhanceHighlightedRegions(imagePath, highlightRegions, sessionDir) {
        try {
     ...
     */
    async quickEnhanceWithHighlights(inputPath) {
        const options = {
            enhanceContrast: true,
            removeNoise: true,
            correctSkew: true,
     ...
     */
    async aggressiveEnhance(inputPath) {
        const options = {
            enhanceContrast: true,
            removeNoise: true,
            correctSkew: true,
     ...
     */
    async medicalOptimize(inputPath) {
        const options = {
            enhanceContrast: true,
            removeNoise: true,
            correctSkew: true,
     ...
     */
    async enhancedHandwritingOptimize(inputPath) {
     ...
     */
    async enhancedTableOptimize(inputPath) {
     ...
     */
    async enhancedGeneralOptimize(inputPath) {
     ...
     */
    generateOutputPath(inputPath, type) {
     ...
     */
    async tesseractOptimize(inputPath) {
     ...
     */
    async enhancedPreprocessing(inputPath, options = {}) {
        ...
        try {
            ...
            if (options.applyCLAHE) {
                ...
                currentPath = await this.applyCLAHE(currentPath, clahePath, options.claheClipLimit, options.claheTileSize);
            ...
            if (options.enhanceEdges) {
                ...
                currentPath = await this.enhanceEdges(currentPath, edgePath, options.edgeStrength || 1.0);
            ...
            if (options.optimizeHighlightedText) {
                ...
                if (highlightDetectionResult.hasHighlights) {
                    ...
                    currentPath = await this.optimizeHighlightedRegions(currentPath, highlightDetectionResult.highlightRegions, highlightPath);
     ...
     */
    async applyCLAHE(imagePath, outputPath, clipLimit = 2.0, tileGridSize = 8) {
        try {
     ...
     */
    async enhanceEdges(imagePath, outputPath, strength = 1.0) {
        try {
     ...
     */
    async normalizeImage(imagePath, outputPath) {
        try {
     ...
     */
    async correctPerspective(imagePath, outputPath) {
        try {
     ...
     */
    async deskewImage(imagePath, outputPath) {
        try {
     ...
     */
    async optimizeHighlightedRegions(imagePath, highlightRegions, outputPath) {
        if (highlightRegions.length === 0) {
            return imagePath;
        }
        try {
